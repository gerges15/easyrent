...
<main class="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center px-4">
  <div class="w-full max-w-2xl p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-xl space-y-6">
    ...
    <form id="studentForm" class="space-y-4 hidden">
      ...
      <button type="submit" class="w-full bg-indigo-600 text-white py-2 rounded-md hover:bg-indigo-700">Create Student Account</button>
    </form>
...
export function initSignUpEvents() {
  ...
  setupToggle("ownerPassword", "toggleOwnerPassword");
  ...
  document
    .getElementById("generateOwnerPass")
    ?.addEventListener("click", () => {
